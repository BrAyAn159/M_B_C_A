...
public class pregunta5MBCA {

    static Scanner st=new Scanner(System.in);

    public static void Xpregunta1MBCA() {
        String Nl;
    double Nec, NE, Ntp; 
    ...
    public static void Xpregunta2MBCA() {
    ...
    public static void Xpregunta3MBCA() {
        int v1, v2;
        double R;
   ...
   public static void Xpregunta4MBCA() {
    int edad;
    String sexo;
    String v; 
    ...
    public static void main(String[] args) {
        ...
        switch (pregunta) {
          case 1:
            Xpregunta1MBCA(); break;
          case 2:
            Xpregunta2MBCA(); break;
          case 3:
            Xpregunta3MBCA(); break;
          case 4:
            Xpregunta4MBCA(); break;
